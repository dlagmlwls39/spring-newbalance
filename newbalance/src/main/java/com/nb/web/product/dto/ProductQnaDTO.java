...
public class ProductQnaDTO {
	...
	public ProductQnaDTO(String userId, String qnaWritedate, String qnaStatus, String qnaTitle, String qnaContent,
	...
	public ProductQnaDTO(String userCode, String pdCode, String qnaTitle, String qnaContent, String qnaFile,
			int qnaPrivate) {
		super();
		this.userCode = userCode;
		this.pdCode = pdCode;
